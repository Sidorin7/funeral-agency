...
<head>
  ...
  <title>Ассортимент памятников</title>
  ...
  <?php
      include('favicon.php')
  ?>
  <meta name="description" content="Купить памятник недорого в Брянске по адресам указанным на сайте днем и ночью" />
            ...
            <div class="katolog__heading">
              <h1 class="katolog__heading-title">
                Памятники
							...
							<!-- <h2 style="margin-top: 20px; font-size: 30px;">Каталог в разработке...</h2> -->
            </div>
          </div>
        </div>
...
<script type="module" src="./components/Product-pamatniki/Product.js"></script>
